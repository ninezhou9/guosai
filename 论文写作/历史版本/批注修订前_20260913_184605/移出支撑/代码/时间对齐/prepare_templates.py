...
Q2=ROOT/'代码/问题二/results'
Q3=ROOT/'代码/问题三/results'
Q4=ROOT/'代码/问题四/results'
...
def prepare():
    ...
    specs=[dict(file='result1.xlsx',ready=q1_ready,kind='single',
                ...
                plans={'计划购电量':[[v] for v in match_template_day(g1,q1_tail)]},
    ...
    for name,a,plans,cidx,didx,eidx,bidx,aidx,tag in data:
        ...
        for sheet,(g,cost) in plans.items():
            ...
            for i in range(334):
                ...
                vals=match_template_day(g[i],tail)
    ...
    sources += [ROOT/'代码/问题一/q1_solution.py',Q2.parent/'fresh_engine.py',Q2.parent/'run_fresh.py',
