...
本参赛队在竞赛过程中使用了 ChatGPT，主要用于建模方案讨论、代码检查与调试；参赛队已人工修改建模方案并核验代码。详见支撑文件。

# 附录

## A 支撑文件列表

1. AI工具使用详情.pdf、AI使用说明.docx、AI使用说明.txt。

2. 源码/：全部代码文件。

3. 结果/：结果工作簿、结果汇总、逐日结果、主策略明细、调整账本、指定日期表和敏感性结果。

4. 图表/：结果图。

5. 环境/、核验/、准备复现.py、核验支撑包.py、README_支撑材料说明.txt、参考文献来源.txt、文件校验清单.json。
